...
unsigned swss_flags = SWS_BICUBIC;

int realloc_texture(SDL_Texture **texture, Uint32 new_format, int new_width, int new_height, SDL_BlendMode blendmode, int init_texture, SDL_Renderer *renderer)
{
    Uint32 format;
    int access, w, h;
